...
namespace TJAPlayer3
{
	internal class CStageコンフィグ : CStage
	{
		...
		public override int OnDraw()
		{
			...
			{
				if ( ( TJAPlayer3.Input管理.Keyboard.bキーが押された( (int) SlimDX.DirectInput.Key.Escape ) || TJAPlayer3.Pad.b押された( EInstrumentPart.DRUMS, Eパッド.FT ) ) || TJAPlayer3.Pad.b押されたGB( Eパッド.FT ) )
				{
				...
				else if ( ( TJAPlayer3.Pad.b押されたDGB( Eパッド.CY ) || TJAPlayer3.Pad.b押された( EInstrumentPart.DRUMS, Eパッド.RD ) ) || ( TJAPlayer3.Pad.b押された( EInstrumentPart.DRUMS, Eパッド.LC ) || ( TJAPlayer3.ConfigIni.bEnterがキー割り当てのどこにも使用されていない && TJAPlayer3.Input管理.Keyboard.bキーが押された( (int) SlimDX.DirectInput.Key.Return ) ) ) )
				{
